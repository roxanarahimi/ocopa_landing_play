<template>
  <div class="w-100 min-vh-100 d-none d-lg-grid text-center bg">
    <div class="row p-0 m-0 h-100">
        ...
        <div class="ps-5 align-self-center">
          <div class="row ps-5">
            ...
            <div class="col-4 mx-auto px-2 mt-4">
              ...
              <a
                  href="https://www.okala.com/search?search_text=%D8%A7%D9%88%DA%A9%D9%88%D9%BE%D8%A7&sort=7"
              ...
              <a
                  href="https://express.snapp.market/search-result?query=%D8%A7%D9%88%DA%A9%D9%88%D9%BE%D8%A7"
              ...
              <a
                  href="https://www.digikala.com/search/?brands%5B0%5D=7629&q=%D8%A7%D9%88%DA%A9%D9%88%D9%BE%D8%A7"
      ...
      <div class="col-4 h-100 text-center d-grid">
        <div class="text-center align-self-start">
          <img src="/img/logo.png" class="d-block mx-auto" width="150" alt="">
          <img src="/img/txt.png" class="d-block mx-auto  my-4" width="250" alt="">
        </div>
        <div class="text-center align-self-center">
          <div class="text-center mx-auto" style="width: 180px">
            <img src="/img/smiley.png" class="mx-auto w-100" alt="">
          </div>
          <div class="text-center mx-auto mb-3" style="width: 300px">
        ...
        <div class="text-light align-self-end">
          <div class="text-center mx-auto" style="width: 150px">
            <img src="/img/barcode.png" class="mx-auto w-100" alt="">
          </div>
  ...
  <div class="w-100 min-vh-100 d-grid d-lg-none text-center bgM">
    <div class="row p-0 m-0 align-self-stretch ">
      <div class="col-12 mainMob text-center">
        <div class="row">
          <div class="col-5 d-grid h-100 px-0">
            <div class="align-self-start">
              <img src="/img/logo.png" class="d-block mx-auto align-self-center mb-3" width="100" alt="">
            </div>
            <div class="align-self-center my-3">
              <img src="/img/txt.png" class="d-block mx-auto align-self-center" width="80%" alt="">
            </div>
            <div class="align-self-end">
              <img src="/img/barcode2.png" class="d-block mx-auto align-self-center" width="100%" alt="">
            </div>
          </div>
          <div class="col-7 ps-0 pe-1 d-grid">
            <div class="align-self-center ">
              <img src="/img/smiley.png" class="d-block mx-auto align-self-center"  width="50%"  alt="">
              <img src="/img/pic.png" class="d-block mx-auto align-self-center"  width="90%"  alt="">
            </div>
                  ...
                  <div class="col-lg-8">
                    <div class="position-relative cursor-pointer text-center disabled-wheel " @click="play">
                      <img src="/img/gb.png" class="img-fluid mx-auto mt-3 ww" width="80%"
                           alt="">
                      <img src="/img/bf.png" class="img-fluid mx-auto "
                           style="position: absolute; top:10px; left:39%"
                           width="21%" alt="">
                    </div>
                  </div>
                </div>
...
export default {
  ...
  setup() {
    ...
    const play = () => {
      ...
      axios.post(apiUrl + '/api/play', {mobile: mobile.value,type:'ocopa'})
          .then((response) => {
